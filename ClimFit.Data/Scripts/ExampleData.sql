...
-- OutfitSuggestion
-- Dikkat: Burada WeatherLogId'yi ve UserId'yi doðru eþlemelisin. 
-- (INSERT sonrasý oluþan ID'leri bilmen lazým ya da bir SELECT yapýp çekmelisin)
INSERT INTO OutfitSuggestion (UserId, WeatherLogId, SuggestedText, IsLiked, IsDeleted, IsActive, CreatorUserId, CreatedDate)
VALUES 
('A1B2C3D4-E5F6-7890-1234-56789ABCDEF0', (SELECT TOP 1 Id FROM WeatherLog ORDER BY CreatedDate DESC),
'Bugün için siyah mont, beyaz tiþört ve kot pantolon kombinasyonu uygundur.', 0, 0, 1, 'A1B2C3D4-E5F6-7890-1234-56789ABCDEF0', GETDATE());

-- OutfitItems
-- OutfitSuggestion ve ClothingItem id'lerini dinamik çekerek baðlayacaðýz
...
(
    ...
    (SELECT TOP 1 Id FROM ClothingItem WHERE Name = 'Siyah Mont'),
    0, 1, 'A1B2C3D4-E5F6-7890-1234-56789ABCDEF0', GETDATE()
),
(
    (SELECT TOP 1 Id FROM OutfitSuggestion ORDER BY CreatedDate DESC),
    (SELECT TOP 1 Id FROM ClothingItem WHERE Name = 'Kot Pantolon'),
    0, 1, 'A1B2C3D4-E5F6-7890-1234-56789ABCDEF0', GETDATE()
),
(
    (SELECT TOP 1 Id FROM OutfitSuggestion ORDER BY CreatedDate DESC),
    (SELECT TOP 1 Id FROM ClothingItem WHERE Name = 'Beyaz Tiþört'),
    0, 1, 'A1B2C3D4-E5F6-7890-1234-56789ABCDEF0', GETDATE()
);
